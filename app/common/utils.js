...
utils.getScreenSize = () => {
    ...
    if (window.innerWidth < constants.SCREEN_SIZE.S_480) {
        screenSize = constants.SCREEN_SIZE.S_320;
    } else if (window.innerWidth < constants.SCREEN_SIZE.S_768) {
        screenSize = constants.SCREEN_SIZE.S_480;
    } else if (window.innerWidth < constants.SCREEN_SIZE.S_1080) {
        screenSize = constants.SCREEN_SIZE.S_768;
    } else if (window.innerWidth < constants.SCREEN_SIZE.S_1440) {
        screenSize = constants.SCREEN_SIZE.S_1080;
    } else {
        screenSize = constants.SCREEN_SIZE.S_1440;
    }
